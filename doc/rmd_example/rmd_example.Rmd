...
```{r horse-pop, out.width="100%", echo = FALSE, fig.cap = "Horse populations for all provinces in Canada from 1906 - 1972"}
...
```{r horse-pop-large-sd, out.width="60%", echo = FALSE, fig.cap = "Horse populations for the province with the largest standard deviation"}
